...
public class XmlMain {
	...
	public static void test1() {
		ApplicationContext context = new ClassPathXmlApplicationContext("com/ssm/chapter10/config/spring-config.xml");
	...
	public static void test2() {
		ApplicationContext context = new ClassPathXmlApplicationContext("com/ssm/chapter10/config/spring-props.xml");
		DataSourceBean dsBean = context.getBean(DataSourceBean.class);
		System.out.println(dsBean.getUrl());
	}

	public static void test3() {
		ApplicationContext ctx = new ClassPathXmlApplicationContext("com/ssm/chapter10/config/spring-props.xml");
